...
*/
let numFuncionario = 6; //parseInt(lines[0]);
let numHorasTrabalhadas = 145; //parseInt(lines[1]);
let valorPorHora = 15.55; //parseFloat(lines[2]);
let salario = (numHorasTrabalhadas * valorPorHora).toFixed(2);
